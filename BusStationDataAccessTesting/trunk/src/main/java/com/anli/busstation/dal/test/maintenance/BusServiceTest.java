...
public abstract class BusServiceTest extends BasicDataAccessTestSceleton<BusService> {
    ...
    protected void updateEntityByProvider(BigInteger id, BusService sourceService) throws Exception {
        ...
        if (sourceService instanceof BusRepairment) {
            ((BusRepairment) service)
                    .setExpendablesPrice(((BusRepairment) sourceService).getExpendablesPrice());
        }
    ...
    protected List<BusService> getCreationTestSets() throws Exception {
        ...
        testSets.add(getNewRepairment(BigInteger.ZERO, null, null, null, BigDecimal.ZERO, null,
                BigDecimal.ZERO));
    ...
    protected List<BusService> getSearchTestSets() throws Exception {
        ...
        testSets.add(getNewRefuelling(BigInteger.ZERO, BigInteger.valueOf(53),
                new DateTime(2014, 5, 9, 2, 44, 0, 0), new DateTime(2015, 1, 1, 1, 1, 0, 0),
                BigDecimal.valueOf(1234.56), BigInteger.valueOf(60), 100));
        testSets.add(getNewRepairment(BigInteger.ZERO, BigInteger.valueOf(53),
                new DateTime(2014, 5, 9, 2, 45, 0, 0), new DateTime(2015, 1, 1, 1, 2, 0, 0),
                BigDecimal.valueOf(3356.79), BigInteger.valueOf(61), BigDecimal.valueOf(600.25)));
        testSets.add(getNewRefuelling(BigInteger.ZERO, BigInteger.valueOf(53),
                new DateTime(2014, 5, 9, 3, 15, 0, 0), new DateTime(2015, 1, 1, 1, 3, 0, 0),
                BigDecimal.valueOf(5560.55), BigInteger.valueOf(61), 756));
        testSets.add(getNewRepairment(BigInteger.ZERO, BigInteger.valueOf(54),
                new DateTime(2014, 5, 9, 8, 20, 0, 0), new DateTime(2015, 1, 1, 2, 1, 0, 0),
        ...
        testSets.add(getNewRefuelling(BigInteger.ZERO, BigInteger.valueOf(59),
                new DateTime(2014, 5, 9, 8, 21, 0, 0), new DateTime(2015, 1, 1, 5, 6, 0, 0),
                BigDecimal.valueOf(6789.02), BigInteger.valueOf(68), 1500));
        testSets.add(getNewRepairment(BigInteger.ZERO, BigInteger.valueOf(59),
                new DateTime(2014, 5, 10, 2, 45, 0, 0), new DateTime(2015, 1, 2, 5, 6, 0, 0),
                BigDecimal.valueOf(7002.12), BigInteger.valueOf(67), BigDecimal.valueOf(3333.33)));
        return testSets;
    }
