...
public abstract class SalesmanTest extends BasicDataAccessTestSceleton<Salesman> {
    ...
    protected List<Salesman> getCreationTestSets() throws Exception {
        ...
        testSets.add(getNewSalesman(BigInteger.ZERO, "", BigDecimal.ZERO, new DateTime(0), Integer.valueOf(0)));
    ...
    protected List<Salesman> getSearchTestSets() throws Exception {
        ...
        testSets.add(getNewSalesman(BigInteger.ZERO, "Кассир 10", BigDecimal.valueOf(18500.42), new DateTime(2000, 1, 2, 0, 0, 0, 0), null));
        testSets.add(getNewSalesman(BigInteger.ZERO, "Кассирша 11", BigDecimal.valueOf(21499.99), new DateTime(2000, 1, 3, 0, 0, 0, 0), Integer.valueOf(100)));
        testSets.add(getNewSalesman(BigInteger.ZERO, "Кассир 12", BigDecimal.valueOf(21500), new DateTime(2003, 10, 31, 0, 0, 0, 0), Integer.valueOf(300)));
        testSets.add(getNewSalesman(BigInteger.ZERO, "Елена Михайлова", BigDecimal.valueOf(33333.33), new DateTime(2007, 5, 9, 0, 0, 0, 0), Integer.valueOf(900)));
        testSets.add(getNewSalesman(BigInteger.ZERO, "Кассирша 14", BigDecimal.valueOf(33333.34), new DateTime(2007, 5, 10, 0, 0, 0, 0), Integer.valueOf(901)));
