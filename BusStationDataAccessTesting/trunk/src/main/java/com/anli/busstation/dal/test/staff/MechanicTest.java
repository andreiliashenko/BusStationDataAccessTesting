...
public abstract class MechanicTest extends BasicDataAccessTestSceleton<Mechanic> {
    ...
    protected List<Mechanic> getUpdateTestSets() throws Exception {
        List<Mechanic> testSets = new ArrayList<>(4);
        testSets.add(getNewMechanic(BigInteger.ZERO, "Обновленный механик 0", BigDecimal.valueOf(21111.99), new DateTime(2003, 3, 3, 0, 0, 0, 0), BigInteger.valueOf(50)));
    ...
    protected List<List<BigInteger>> performCollectings() throws Exception {
        ...
        searchResult.add(resultCollection);
        resultCollection = provider.collectIdsByHiringDateRange(new DateTime(2000, 1, 1, 0, 0, 0, 0), false, new DateTime(2005, 4, 19, 0, 0, 0, 0), true);
        searchResult.add(resultCollection);
        resultCollection = provider.collectIdsBySalaryRange(BigDecimal.valueOf(7500), true, BigDecimal.valueOf(15579.99), false);
        searchResult.add(resultCollection);
    ...
    protected List<Mechanic> getSearchTestSets() throws Exception {
        ...
        testSets.add(getNewMechanic(BigInteger.ZERO, "", BigDecimal.valueOf(6000), null, BigInteger.valueOf(50)));
        testSets.add(getNewMechanic(BigInteger.ZERO, "Механик 0", BigDecimal.valueOf(7499.99), new DateTime(2000, 1, 1, 0, 0, 0, 0), BigInteger.valueOf(51)));
        testSets.add(getNewMechanic(BigInteger.ZERO, "Механик Два", BigDecimal.valueOf(7500), new DateTime(2005, 4, 18, 0, 0, 0, 0), BigInteger.valueOf(52)));
        testSets.add(getNewMechanic(BigInteger.ZERO, "Механик 01", BigDecimal.valueOf(15579.99), new DateTime(2005, 4, 19, 0, 0, 0, 0), BigInteger.valueOf(53)));
        testSets.add(getNewMechanic(BigInteger.ZERO, "Механик 22", BigDecimal.valueOf(15580), new DateTime(2006, 4, 19, 0, 0, 0, 0), BigInteger.valueOf(54)));
    ...
    protected abstract Mechanic getNewMechanic(BigInteger id, String name, BigDecimal salary, DateTime hiringDate,
