...
public abstract class EmployeeTest extends BasicDataAccessTestSceleton<Employee> {
    ...
    protected List<Employee> getCreationTestSets() throws Exception {
        ...
        testSets.add(getNewMechanic(BigInteger.ZERO, "Механик Механикович",
                BigDecimal.valueOf(33000.01), new DateTime(1997, 11, 30, 0, 0, 0, 0),
    ...
    protected List<Employee> getSearchTestSets() throws Exception {
        ...
        testSets.add(getNewDriver(BigInteger.ZERO, null, BigDecimal.valueOf(7000),
                new DateTime(1998, 7, 7, 0, 0, 0, 0), BigInteger.valueOf(40)));
        testSets.add(getNewMechanic(BigInteger.ZERO, "", BigDecimal.valueOf(15300.24),
                new DateTime(1998, 7, 8, 0, 0, 0, 0), BigInteger.valueOf(50)));
        testSets.add(getNewSalesman(BigInteger.ZERO, "Нужное имя", BigDecimal.valueOf(15300.25),
                new DateTime(2000, 3, 11, 0, 0, 0, 0), null));
        testSets.add(getNewSalesman(BigInteger.ZERO, "Кассир 3", BigDecimal.valueOf(18999.99),
                new DateTime(2000, 5, 21, 0, 0, 0, 0), Integer.valueOf(500)));
        testSets.add(getNewDriver(BigInteger.ZERO, "Нужное имя", null, new DateTime(2005, 1, 1, 0, 0, 0, 0),
                BigInteger.valueOf(43)));
        testSets.add(getNewDriver(BigInteger.ZERO, "Водитель 7", BigDecimal.valueOf(20500.23), null,
                BigInteger.valueOf(44)));
        testSets.add(getNewMechanic(BigInteger.ZERO, "Нужное имя", BigDecimal.valueOf(25252.52),
                new DateTime(2007, 11, 10, 0, 0, 0, 0), null));
        testSets.add(getNewMechanic(BigInteger.ZERO, "Механик 2", BigDecimal.valueOf(25252.53),
                new DateTime(2007, 11, 13, 0, 0, 0, 0), BigInteger.valueOf(52)));
        return testSets;
    }
